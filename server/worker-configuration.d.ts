/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 92f4f6359b167581333dc6851cee15b5)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NPCDurableObject" | "ArenaRoomDurableObject";
	}
	interface Env {
		WORLD_SNAPSHOTS: R2Bucket;
		DB: D1Database;
		VECTORIZE_INDEX: VectorizeIndex;
		AI: Ai;
		ASSETS: Fetcher;
		ELEVENLABS_VOICE_ID: "21m00Tcm4TlvDq8ikWAM";
		SYSTEM_PROMPT: "You are a helpful AI developer NPC assisting a user in a 3D playground.";
		GOOGLE_CLIENT_ID: "826228158551-8vghpn3ibpelq7hlds19vbejvblfa91v.apps.googleusercontent.com";
		FRONTEND_URL: "https://deverse-server.saraswatdevesh98.workers.dev";
		CF_ACCOUNT_ID: "";
		CF_API_TOKEN: "";
		RTK_APP_ID: "";
		ELEVENLABS_API_KEY: string;
		JWT_SECRET: string;
		NPC_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").NPCDurableObject>;
		ARENA_ROOM: DurableObjectNamespace<import("./src/index").ArenaRoomDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ELEVENLABS_VOICE_ID" | "SYSTEM_PROMPT" | "GOOGLE_CLIENT_ID" | "FRONTEND_URL" | "CF_ACCOUNT_ID" | "CF_API_TOKEN" | "RTK_APP_ID" | "ELEVENLABS_API_KEY" | "JWT_SECRET">> {}
}
